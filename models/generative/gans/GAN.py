...
class GAN:
    ...
    def generator(self, z_input, reuse, is_train, init, label_input=None):
        with tf.variable_scope('generator', reuse=reuse):
            ...
            logits = convolutional(inputs=net, output_channels=self.image_channels, filter_size=4, stride=2,
                                   padding='SAME', conv_type='transpose', scope=4)
            # Shape = (None, 56, 56, 3)
    ...
    def build_model(self):
        ...
        self.fake_images = self.generator(self.z_input, reuse=False, is_train=True, init=self.init,
        ...
        self.output_gen = self.generator(self.z_input, reuse=True, is_train=False, init=self.init,
                                         label_input=self.label_input)
